...
import { Comment, Priority, Project, Status, Task, User } from '@/types';
            ...
            <div class="mb-6 flex items-center justify-between">
                ...
                <div>
                    ...
                    <Button v-if="isEditMode" as-child>
                        <Link :href="route('tasks.show', task.id)"> Cancel </Link>
                    </Button>
                    <AlertDialog>
                        ...
                        <AlertDialogContent>
                            ...
                            <AlertDialogFooter>
                                ...
                                <AlertDialogAction as-child>
                                    <Button as-child>
                                        <Link method="delete" :href="route('tasks.delete', props.task.id)"> Confirm </Link>
                                    </Button>
                                </AlertDialogAction>
                            </AlertDialogFooter>
                        </AlertDialogContent>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            <div class="flex flex-col gap-1">
                                ...
                                <ProjectSelect id="project-selector" :disabled="!isEditMode" :projects="projects" v-model="form.project_id" />
                            </div>
